              ...
              <div className="col-sm-6 col-lg-3 mb-30">
                <div className="footer-widget">
                  ...
                  <p className="mb-30">
                    ...
                    your business exponentially by providing wholesale raw items with 
                    100% pure quality and guarantee.
                  </p>
                </div>
                ...
                <div className="footer-widget mt-8">
                 ...
                 <ul
                  ...
                  >
                    <li>
                      <a
                        href="https://github.com/Code-Blooded-96"
                        target="_blank"
                    ...
                    <li>
                      <a
                        href="https://instagram.com/co.deblooded"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="instagram"
                      >
                    ...
                    <li>
                      <a
                        href="https://linkedin.com/in/code-blooded"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="linkedin"
                      >
            ...
            <div className="container text-center">
              <div className="footer-copy">
                <div className="copyright">
                  ...
                  <Link
                    to="https://github.com/Code-Blooded-96"
                    target="_blank"
                  >
                     @Code-Blooded
                  </Link>
