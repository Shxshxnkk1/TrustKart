            ...
            <div className="container">
              <div className="row">
                <div className="col-md-10 col-12 d-flex " style={{ alignItems: 'center' }}>
                  <span> Super Value wholesale Deals - curated specifically for your street vendor business</span>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-start ">
                <div>
                  ...
                  <p className="mb-0 small">
                    Enter your address and we will specify the offer applicable based on your
                    area.{" "}
                  </p>
                </div>
                <button
