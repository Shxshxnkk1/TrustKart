                        ...
                        >
                          <div className="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                            ...
                            <h2 className="text-dark display-5 fw-bold mt-4">
                              Wholesale B2B Supply <br /> 24/7 Delivery
                            </h2>
                            <p className="lead">
                              An E-commerce platform which supplies necessary Raw Materials to Street vendors
                              on demand with ease and guaranatee.
                            </p>
                          ...
                          <div className="wt-icon-box-wraper center p-a25 p-b50 m-b30 bdr-1 bdr-gray bdr-solid corner-radius step-icon-box bg-white v-icon-effect">
                            ...
                            <div className="icon-content">
                              ...
                              <p>
                                ...
                                earliest from TrustKart pickup
                                <p> stores near you.</p>
                              </p>
                            </div>
                          </div>
