        ...
        {loaderStatus ? (
                ...
                <div className="container position-relative zindex-5 pt-5">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <h1 className="pb-2 pb-md-3">About TrustKart</h1>
                      <h3 className="pb-2 pb-md-3">The Future of Wholesale Raw Items Delivery:</h3>
                      <p
                        className="fs-xl pb-4 mb-1 mb-md-2 mb-lg-3"
                        style={{ maxWidth: 526 }}
                      >
                  By powering the future of wholesale delivery with our retail partners, 
                  we give every Street vendor the opportunity to check and buy necessary raw items
                  with ease on our platform. 
                      </p>
                      <img
                        src={clutch}
          ...
          <div className="position-relative rounded-3 overflow-hidden">
            <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center zindex-5">
              <a
                href="https://youtu.be/so-VUmd_6RY?si=5CbMSZ726C3J0h-n"
                  ...
                  <div className="col-md-5">
                    ...
                    >
                      ...
                      <div className="gallery-item-caption p-4">
                        <h4 className="text-light mb-1">TrustKart Inc.</h4>
                        <p className="mb-0">Showreel by Team Code-Blooded</p>
                      </div>
                    </a>
                  </div>
